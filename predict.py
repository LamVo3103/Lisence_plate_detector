...
def process_plate_text(raw_text):
    """
    Hậu xử lý THUẦN TÚY dựa trên logic và định dạng biển số VN.
    Cập nhật thêm kinh nghiệm nhận diện sai của AI (Q->0, 4->A).
    """
    ...
    # --- CẬP NHẬT TỪ ĐIỂN KINH NGHIỆM ---
    # Thêm 'Q': '0' (AI hay nhầm O, D, Q thành số 0)
    num_map = {'O': '0', 'D': '0', 'I': '1', 'L': '1', 'Z': '2', 'B': '8', 'S': '5', 'G': '6', 'Q': '0'}

    # Thêm '4': 'A' (AI hay nhầm chữ A thành số 4)
